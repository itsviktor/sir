...
type PostgreSQLParserVisitor interface {
	...
	// Visit a parse tree produced by PostgreSQLParser#c_expr_dsqlparam.
	VisitC_expr_dsqlparam(ctx *C_expr_dsqlparamContext) interface{}
	...
	// Visit a parse tree produced by PostgreSQLParser#dsql_param.
	VisitDsql_param(ctx *Dsql_paramContext) interface{}
