// Code generated from grammar/postgres/PostgreSQLParser.g4 by ANTLR 4.13.2. DO NOT EDIT.
...
// EnterC_expr_dsqlparam is called when production c_expr_dsqlparam is entered.
func (s *BasePostgreSQLParserListener) EnterC_expr_dsqlparam(ctx *C_expr_dsqlparamContext) {}

// ExitC_expr_dsqlparam is called when production c_expr_dsqlparam is exited.
func (s *BasePostgreSQLParserListener) ExitC_expr_dsqlparam(ctx *C_expr_dsqlparamContext) {}
...
// EnterDsql_param is called when production dsql_param is entered.
func (s *BasePostgreSQLParserListener) EnterDsql_param(ctx *Dsql_paramContext) {}

// ExitDsql_param is called when production dsql_param is exited.
func (s *BasePostgreSQLParserListener) ExitDsql_param(ctx *Dsql_paramContext) {}
