...
type PostgreSQLParserListener interface {
	...
	// EnterC_expr_dsqlparam is called when entering the c_expr_dsqlparam production.
	EnterC_expr_dsqlparam(c *C_expr_dsqlparamContext)
	...
	// EnterDsql_param is called when entering the dsql_param production.
	EnterDsql_param(c *Dsql_paramContext)
	...
	// ExitC_expr_dsqlparam is called when exiting the c_expr_dsqlparam production.
	ExitC_expr_dsqlparam(c *C_expr_dsqlparamContext)
	...
	// ExitDsql_param is called when exiting the dsql_param production.
	ExitDsql_param(c *Dsql_paramContext)
