...
func (v *BasePostgreSQLParserVisitor) VisitC_expr_dsqlparam(ctx *C_expr_dsqlparamContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePostgreSQLParserVisitor) VisitDsql_param(ctx *Dsql_paramContext) interface{} {
	return v.VisitChildren(ctx)
}
